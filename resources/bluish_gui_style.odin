...
bluishStyleProps: [BLUISH_STYLE_PROPS_COUNT]GuiStyleProp = {
    { .DEFAULT, 0,0x5ca6a6ff },   // DEFAULT_BORDER_COLOR_NORMAL 
    { .DEFAULT, 1,0xb4e8f3ff },   // DEFAULT_BASE_COLOR_NORMAL 
    { .DEFAULT, 2,0x447e77ff },   // DEFAULT_TEXT_COLOR_NORMAL 
    { .DEFAULT, 3,0x5f8792ff },   // DEFAULT_BORDER_COLOR_FOCUSED 
    { .DEFAULT, 4,0xcdeff7ff },   // DEFAULT_BASE_COLOR_FOCUSED 
    { .DEFAULT, 5,0x4c6c74ff },   // DEFAULT_TEXT_COLOR_FOCUSED 
    { .DEFAULT, 6,0x3b5b5fff },   // DEFAULT_BORDER_COLOR_PRESSED 
    { .DEFAULT, 7,0xeaffffff },   // DEFAULT_BASE_COLOR_PRESSED 
    { .DEFAULT, 8,0x275057ff },   // DEFAULT_TEXT_COLOR_PRESSED 
    { .DEFAULT, 9,0x96aaacff },   // DEFAULT_BORDER_COLOR_DISABLED 
    { .DEFAULT, 10,0xc8d7d9ff },   // DEFAULT_BASE_COLOR_DISABLED 
    { .DEFAULT, 11,0x8c9c9eff },   // DEFAULT_TEXT_COLOR_DISABLED 
    { .DEFAULT, 18,0x84adb7ff },   // DEFAULT_LINE_COLOR 
    { .DEFAULT, 19,0xe8eef1ff },   // DEFAULT_BACKGROUND_COLOR 
};

// WARNING: This style uses a custom font: "homespun.ttf" (size: 10,spacing: 1)
BLUISH_STYLE_FONT_ATLAS_COMP_SIZE :: 2914

// Font atlas image pixels data: DEFLATE compressed
bluishFontData: [BLUISH_STYLE_FONT_ATLAS_COMP_SIZE]u8 = { 0xed,
...
bluishFontRecs: [189]rl.Rectangle = {
    { 4,4,5 ,10 },
    { 17,4,2 ,8 },
    { 27,4,4 ,3 },
    { 39,4,6 ,8 },
...
bluishFontGlyphs: [189]rl.GlyphInfo = {
    { 32,0,9,5,{ }},
    { 33,0,1,2,{ }},
    { 34,0,1,4,{ }},
    { 35,0,1,6,{ }},
...
GuiLoadStyleBluish :: proc() {
    using rl
    // Load style properties provided
    // NOTE: Default properties are propagated
    for prop in bluishStyleProps {
        using prop
        GuiSetStyle(controlId, propertyId, i32(propertyValue))
    }

    // Custom font loading
    // NOTE: Compressed font image data (DEFLATE), it requires DecompressData() function
    bluishFontDataSize: i32
    data := DecompressData(rawptr(&bluishFontData), BLUISH_STYLE_FONT_ATLAS_COMP_SIZE, &bluishFontDataSize)
    imFont := Image{ data, 256, 256, 1, .UNCOMPRESSED_GRAY_ALPHA }
    ...
    when false {
        ...
        // TODO: NOTE: Required to avoid issues if trying to free font
        font.recs = raw_data(bluishFontRecs[:])

        // Copy font char info data from global fontChars
        // TODO: NOTE: Required to avoid issues if trying to free font
        font.glyphs = raw_data(bluishFontGlyphs[:])
    } else {
        font = LoadFont_PoetsenOne()
    }
    ...
    // fontWhiteRec := Rectangle{ 254, 254, 1, 1 }
